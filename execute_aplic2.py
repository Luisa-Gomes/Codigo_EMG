...
def abrir_ficheiro(direct_open):
    ...
    exec1.abrir_ficheiro(direct_open)
    plots1.abrir_ficheiro(direct_open)
    plots2.abrir_ficheiro(direct_open)
    
    #colocar ficheiros plots aqui    
    ...
    for moment in range(MOMENTO1, MOMENTO2 + 1): #search each moment
        for sujeito in range(0, len(instrucao)): #search each subject
            ...
            directoria = instrucao.get(iniciais).values()[2]
